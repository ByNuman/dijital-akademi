    ...
    const [curriculum, setCurriculum] = useState([
        {
            ...
            lessons: [
                { id: 1, title: "Dersin Amacı ve Metodolojisi", duration: "15:20", type: "video", completed: true },
                { id: 2, title: "Temel Kavramların Analizi", duration: "24:10", type: "video", completed: true },
                { id: 3, title: "Okuma Parçası: Terminoloji", duration: "10 dk okuma", type: "doc", completed: false },
            ]
        },
        {
            id: 2,
            title: "Modül 2: Tarihsel Arka Plan",
            lessons: [
                { id: 4, title: "Dönemin Siyasi ve Sosyal Yapısı", duration: "32:45", type: "video", completed: false },
                { id: 5, title: "Öncü Alimler ve Eserleri", duration: "28:15", type: "video", completed: false },
                    ...
                    {isSidebarOpen && (
                        ...
                        >
                            <div className="p-5 border-b border-white/5 text-center sm:text-left">
                                ...
                                <p className="text-xs text-gray-500">2 Bölüm, 6 Konu</p>
                            </div>
                        ...
                        <div className="flex-1 flex flex-col">
                            <div className="flex space-x-6 sm:space-x-8 border-b border-white/10 mb-8 overflow-x-auto scrollbar-hide">
                                {[
                                    ...
                                    { id: "materyaller", icon: Monitor, label: "Materyaller (4'lü Set)" },
                            ...
                            <div className="text-gray-300 font-light leading-relaxed flex-1">
                                {activeTab === "genel_bakis" && (
                                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-[#1A1A1A] border border-white/5 rounded-3xl p-8 sm:p-10 shadow-xl">
                                        ...
                                        <p className="mb-6 text-gray-400 text-lg leading-relaxed">
                                            Bu derste, {currentLessonData?.title} konusunun akademik temellerini atacağız. Kaynakların metodolojik incelemesi ve yazarın dönemsel etkileri merkeze alınacaktır. Bu konuyu kendi hızınızda tamamlamak için çoklu format destekleyen <strong>Materyaller</strong> sekmemizi kullanabilirsiniz.
                                        </p>
                                ...
                                {activeTab === "materyaller" && (
                                    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        {/* 4'lü set: PDF, Slayt, Sesli Özet, Test */}
                                        <div className="flex items-center justify-between p-6 bg-[#1A1A1A] border border-white/5 rounded-3xl hover:border-brand-gold/30 transition-all cursor-pointer group hover:-translate-y-1 shadow-lg">
                                        ...
                                        <div className="flex items-center justify-between p-6 bg-[#1A1A1C] border-2 border-brand-gold/20 rounded-3xl hover:border-brand-gold transition-all cursor-pointer group hover:-translate-y-1 shadow-[0_0_30px_rgba(251,191,36,0.05)] relative overflow-hidden">
