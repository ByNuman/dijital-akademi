                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-6">
                    {categories.map((category, index) => (
                        <motion.a
                            ...
                            whileHover={{ y: -5 }}
                            className="glass-effect p-8 rounded-3xl flex flex-col items-center justify-center text-center group cursor-pointer border-white/5 hover:border-brand-gold/40 transition-all gold-glow"
                        >
