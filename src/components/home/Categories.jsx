            ...
            <div className="container mx-auto px-6 md:px-12 relative z-10">
                ...
                <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 md:gap-6">
                    {mockCategories.map((category) => {
                        const lessonCount = courses.filter(course => 
                            (course.category || "").trim().toLowerCase() === category.name.trim().toLowerCase()
                        ).length;
                        ...
                        return (
                            ...
                            >
                                ...
                                <p className="text-gray-500 font-medium text-sm">{lessonCount} Ders</p>
                            </Link>
                        );
                    })}
                </div>
