...
import { X, Monitor, Maximize2, Minimize2, ExternalLink, Loader2 } from "lucide-react";
import { Button } from "../ui/Button";
import { getDrivePreviewUrl } from "../../utils/driveUtils";

export function SlideViewer({ url, onClose, title = "Slayt Sunumu" }) {
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-white/5 bg-[#151515] shrink-0">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-500">Görsel Sunum (PDF)</p>
                        </div>
                    </div>
                ...
                <div className="flex-1 relative bg-[#111] overflow-hidden">
                    {isLoading && (
                        <div className="absolute inset-0 flex flex-col items-center justify-center bg-[#111] z-10">
                            ...
                            <p className="text-gray-400 text-sm font-medium">Slayt yükleniyor...</p>
                        </div>
                    )}
                    <iframe
                        src={embedUrl}
